...
Route::group([
    ...
    Route::group(['prefix' => '/network'], function () {
        ...
        // Keep this literal route before the allocation model binding route below.
        Route::middleware([ResourceLimit::Allocation->middleware()])
            ->post('/allocations/assign', [Client\Servers\NetworkAllocationController::class, 'assign']);
